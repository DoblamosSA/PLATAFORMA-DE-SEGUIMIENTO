...
@php
    $tones = [
        'indigo'  => ['from-blue-500 to-sky-600', 'text-blue-600', 'shadow-blue-500/30'],
...
<div class="group relative overflow-hidden rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/70 dark:border-slate-800 p-5 shadow-sm dark:shadow-black/20 transition hover:shadow-md hover:-translate-y-0.5">
    ...
    <div class="flex items-start justify-between">
        <div>
            ...
            <p class="mt-2 text-3xl font-bold {{ $txt }} dark:brightness-125">{{ $value }}</p>
        </div>
    ...
    @if ($hint)<p class="mt-3 text-xs text-slate-400 dark:text-slate-500">{{ $hint }}</p>@endif
</div>
